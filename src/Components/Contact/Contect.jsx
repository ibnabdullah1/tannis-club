const Contact = () => {
  return (
    <div>
      <div className="container pt-20  pb-10  min-h-screen mx-auto px-2 md:px-4">
        <section className="">
                ...
                <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
                  <div className="flex items-start">
                    ...
                    <div className="ml-6 grow">
                      <p className="mb-1 font-bold text-xl Barlow-Condensed">
                        Technical support
                      </p>
                      <p className="text-neutral-500 ">
                        tennissupport@email.com
                      </p>
                ...
                <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
                  <div className="flex items-start">
                    ...
                    <div className="ml-6 grow">
                      ...
                      <p className="text-neutral-500 ">sales@email.com</p>
                      <p className="text-neutral-500 ">+1 234-567-89</p>
                    </div>
                  </div>
                </div>
                <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
                  <div className="align-start flex">
                    ...
                    <div className="ml-6 grow">
                      ...
                      <p className="text-neutral-500 ">tennispress@email.com</p>
                      <p className="text-neutral-500 ">+1 234-567-89</p>
                    </div>
                  </div>
                </div>
                <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
                  <div className="align-start flex">
                    ...
                    <div className="ml-6 grow">
                      ...
                      <p className="text-neutral-500 ">tennisbugs@email.com</p>
                      <p className="text-neutral-500">+1 234-567-89</p>
                    </div>
                  </div>
                </div>
